...
- (NSString *)localizedNameForValue:(NSInteger)value inColumn:(enum ASControlDescriptionColumn)column {
    ...
    switch (column) {
        case kASAppearanceOrSecondaryFeature:
            if (value >= (int)kASAppearanceLow) {
                enum ASAppearance appearance;
                appearance = (enum ASAppearance)value;
                switch (appearance) {
                    case kASAppearanceLow:          s = NSLocalizedString(@"8.1", nil);     break;
                    case kASAppearanceShallow:      s = NSLocalizedString(@"8.2", nil);     break;
                    case kASAppearanceDeep:         s = NSLocalizedString(@"8.3", nil);     break;
                    case kASAppearanceOvergrown:    s = NSLocalizedString(@"8.4", nil);     break;
                    case kASAppearanceOpen:         s = NSLocalizedString(@"8.5", nil);     break;
                    case kASAppearanceRocky:        s = NSLocalizedString(@"8.6", nil);     break;
                    case kASAppearanceMarshy:       s = NSLocalizedString(@"8.7", nil);     break;
                    case kASAppearanceSandy:        s = NSLocalizedString(@"8.8", nil);     break;
                    case kASAppearanceNeedleLeaves: s = NSLocalizedString(@"8.9", nil);     break;
                    case kASAppearanceBroadLeaves:  s = NSLocalizedString(@"8.10", nil);     break;
                    case kASAppearanceRuined:       s = NSLocalizedString(@"8.11", nil);     break;
                    default:
                        break;
                }
            }
...
- (NSArray *)createPathsForFeatureOrAppearance:(NSNumber *)value transform:(CGAffineTransform *)tran {
    ...
    if ([value intValue] >= (int)kASAppearanceLow) {
        enum ASAppearance appearance;
        appearance = (enum ASAppearance)[value intValue];
        
        switch (appearance) {
            case kASAppearanceLow:
                CGPathMoveToPoint(path, NULL, -38.5, -12.5);
                CGPathAddCurveToPoint(path, NULL, -33.5, -9.5, -22.92, -0.65, 0.5, -0.5);
                CGPathAddCurveToPoint(path, NULL, 23.92, -0.35, 40.5, -13.5, 40.5, -13.5);
                break;
            case kASAppearanceShallow:
                CGPathMoveToPoint(path, NULL, -38.5, 11.5);
                CGPathAddCurveToPoint(path, NULL, -33.5, 8.5, -22.92, -0.35, 0.5, -0.5);
                CGPathAddCurveToPoint(path, NULL, 23.92, -0.65, 40.5, 12.5, 40.5, 12.5);
                break;
            case kASAppearanceDeep:
                CGPathMoveToPoint(path, NULL, -43.5, 46.5);
                CGPathAddCurveToPoint(path, NULL, -35.5, 46.5, -25.12, 47.3, -23.5, 46.5);
                CGPathAddCurveToPoint(path, NULL, -21.88, 45.7, -18.14, 43.69, -17.5, 38.5);
                CGPathAddCurveToPoint(path, NULL, -16.86, 33.31, -17.23, -21.75, -16.5, -25.5);
                CGPathAddCurveToPoint(path, NULL, -15.77, -29.25, -16.4, -38.86, -8.5, -44.5);
                CGPathAddCurveToPoint(path, NULL, -0.6, -50.14, 6.03, -47.47, 9.5, -43.5);
                CGPathAddCurveToPoint(path, NULL, 12.97, -39.53, 16.05, -31.73, 16.5, -27.5);
                CGPathAddCurveToPoint(path, NULL, 16.95, -23.27, 15.39, 35.43, 16.5, 38.5);
                CGPathAddCurveToPoint(path, NULL, 17.61, 41.57, 19.33, 45.03, 23.5, 46.5);
                CGPathAddCurveToPoint(path, NULL, 27.67, 47.97, 47.5, 46.5, 47.5, 46.5);
                break;
            case kASAppearanceOvergrown:
                CGPathMoveToPoint(path, NULL, -29.5, 47.5);
                CGPathAddLineToPoint(path, NULL, -29.5, -48.5);
                CGPathMoveToPoint(path, NULL, -9.5, 47.5);
                CGPathAddLineToPoint(path, NULL, -9.5, -48.5);
                CGPathMoveToPoint(path, NULL, 9.5, 47.5);
                CGPathAddLineToPoint(path, NULL, 9.5, -48.5);
                CGPathMoveToPoint(path, NULL, 29.5, 47.5);
                CGPathAddLineToPoint(path, NULL, 29.5, -48.5);
                CGPathMoveToPoint(path, NULL, -47.5, 29.5);
                CGPathAddLineToPoint(path, NULL, 49.5, 29.5);
                CGPathMoveToPoint(path, NULL, -47.5, 9.5);
                CGPathAddLineToPoint(path, NULL, 49.5, 9.5);
                CGPathMoveToPoint(path, NULL, -47.5, -9.5);
                CGPathAddLineToPoint(path, NULL, 49.5, -9.5);
                CGPathMoveToPoint(path, NULL, -47.5, -29.5);
                CGPathAddLineToPoint(path, NULL, 49.5, -29.5);
                break;
            case kASAppearanceOpen:
                nonfilled = CGPathCreateMutable();
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-50, 36, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-23, 36, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(4, 36, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(32, 36, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-50, 9, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-50, -18, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-50, -46, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-23, -46, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(4, -46, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(32, -46, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(32, -18, 14, 13));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(32, 9, 14, 13));
                break;
            case kASAppearanceRocky:
                nonfilled = CGPathCreateMutable();
                CGPathMoveToPoint(nonfilled, tran, -30, 34);
                CGPathAddLineToPoint(nonfilled, tran, -10.08, 0.25);
                CGPathAddLineToPoint(nonfilled, tran, -49.92, 0.25);
                CGPathCloseSubpath(nonfilled);
                CGPathMoveToPoint(nonfilled, tran, 30, 34);
                CGPathAddLineToPoint(nonfilled, tran, 49.92, 0.25);
                CGPathAddLineToPoint(nonfilled, tran, 10.08, 0.25);
                CGPathCloseSubpath(nonfilled);
                CGPathMoveToPoint(nonfilled, tran, 0, 0);
                CGPathAddLineToPoint(nonfilled, tran, 19.92, -33.75);
                CGPathAddLineToPoint(nonfilled, tran, -19.92, -33.75);
                CGPathCloseSubpath(nonfilled);
                break;
            case kASAppearanceMarshy:
                CGPathMoveToPoint(path, NULL, -20.5, 21.5);
                CGPathAddLineToPoint(path, NULL, 20.5, 21.5);
                CGPathMoveToPoint(path, NULL, -20.5, -0.5);
                CGPathAddLineToPoint(path, NULL, 20.5, -0.5);
                CGPathMoveToPoint(path, NULL, -20.5, -22.5);
                CGPathAddLineToPoint(path, NULL, 20.5, -22.5);
                break;
            case kASAppearanceSandy:
                nonfilled = CGPathCreateMutable();
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-40, 37, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-26, 39, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-8, 35, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(6, 31, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(19, 39, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(33, 34, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-45, 20, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-34, 27, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-19, 28, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-7, 22, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(7, 20, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(23, 23, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(39, 23, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-34, 12, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-19, 15, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-4, 11, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(18, 7, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(31, 11, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-42, -2, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-27, 1, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-13, 1, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(4, -1, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(21, -7, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(37, -6, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(27, -20, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(38, -26, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(32, -39, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(12, -17, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(17, -32, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(19, -46, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(1, -50, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(4, -39, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(1, -25, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-3, -14, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-17, -11, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-30, -15, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-43, -16, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-20, -26, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-10, -35, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-16, -48, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-26, -38, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-38, -31, 8, 8));
                CGPathAddEllipseInRect(nonfilled, tran, CGRectMake(-40, -46, 8, 8));
                break;
            case kASAppearanceNeedleLeaves:
                CGPathMoveToPoint(path, NULL, 0.5, -43.5);
                CGPathAddLineToPoint(path, NULL, 0.5, -13.5);
                CGPathMoveToPoint(path, NULL, -19.5, -14.5);
                CGPathAddLineToPoint(path, NULL, 21.5, -14.5);
                CGPathAddLineToPoint(path, NULL, 7.5, 11.5);
                CGPathMoveToPoint(path, NULL, -6.5, 10.5);
                CGPathAddLineToPoint(path, NULL, -19.5, -13.5);
                CGPathMoveToPoint(path, NULL, -16.5, 12.5);
                CGPathAddLineToPoint(path, NULL, 0.5, 41.5);
                CGPathAddLineToPoint(path, NULL, 18.5, 12.5);
                CGPathAddLineToPoint(path, NULL, -16.5, 12.5);
                CGPathCloseSubpath(path);
                break;
            case kASAppearanceBroadLeaves:
                CGPathMoveToPoint(path, NULL, -0.5, -18.5);
                CGPathAddCurveToPoint(path, NULL, -3.5, -22.5, -7.31, -26.15, -12.5, -26.5);
                CGPathAddCurveToPoint(path, NULL, -17.69, -26.85, -24.75, -24.92, -27.5, -17.5);
                CGPathAddCurveToPoint(path, NULL, -30.25, -10.08, -23.37, -2.27, -21.5, -0.5);
                CGPathMoveToPoint(path, NULL, -12.5, 21.5);
                CGPathAddCurveToPoint(path, NULL, -15.5, 25.5, -17.33, 26.63, -24.5, 26.5);
                CGPathAddCurveToPoint(path, NULL, -31.67, 26.37, -36.69, 16.71, -36.5, 11.5);
                CGPathAddCurveToPoint(path, NULL, -36.31, 6.29, -31.59, -0.82, -21.5, -0.5);
                CGPathMoveToPoint(path, NULL, 12.5, 22.5);
                CGPathAddCurveToPoint(path, NULL, 13.5, 30.5, 13.44, 33.71, 10.5, 38.5);
                CGPathAddCurveToPoint(path, NULL, 7.56, 43.29, -5.31, 45.19, -9.5, 39.5);
                CGPathAddCurveToPoint(path, NULL, -13.69, 33.81, -15.75, 31.78, -12.5, 23.5);
                CGPathMoveToPoint(path, NULL, 21.5, -1.5);
                CGPathAddCurveToPoint(path, NULL, 32.5, -0.5, 32.28, 3.25, 34.5, 7.5);
                CGPathAddCurveToPoint(path, NULL, 36.72, 11.75, 34.33, 20.09, 30.5, 24.5);
                CGPathAddCurveToPoint(path, NULL, 26.67, 28.91, 16.37, 27.46, 12.5, 23.5);
                CGPathMoveToPoint(path, NULL, -0.5, -16.5);
                CGPathAddCurveToPoint(path, NULL, 4.5, -23.5, 6.15, -26.36, 12.5, -26.5);
                CGPathAddCurveToPoint(path, NULL, 18.85, -26.64, 24.45, -23.13, 26.5, -16.5);
                CGPathAddCurveToPoint(path, NULL, 28.55, -9.87, 26.73, -6.57, 21.5, -1.5);
                CGPathMoveToPoint(path, NULL, 1.5, -44.5);
                CGPathAddCurveToPoint(path, NULL, -0.5, -40.5, -1, -41.19, -1.5, -36.5);
                CGPathAddCurveToPoint(path, NULL, -2, -31.81, -0.5, -17.5, -0.5, -17.5);
                break;
            case kASAppearanceRuined:
                CGPathMoveToPoint(path, NULL, -35.5, -44.5);
                CGPathAddCurveToPoint(path, NULL, -35.5, -44.5, -36.5, 23.08, -35.5, 27.5);
                CGPathAddCurveToPoint(path, NULL, -34.5, 31.92, -28.97, 40.98, -21.5, 41.5);
                CGPathAddCurveToPoint(path, NULL, -14.03, 42.02, -8.39, 41.01, -3.5, 36.5);
                CGPathAddCurveToPoint(path, NULL, 1.39, 31.99, 44.5, -19.5, 44.5, -19.5);
                CGPathMoveToPoint(path, NULL, 45.5, 11.5);
                CGPathAddLineToPoint(path, NULL, 45.5, -21.5);
                CGPathAddLineToPoint(path, NULL, 10.5, -21.5);
                break;
            default:
                break;
        }
